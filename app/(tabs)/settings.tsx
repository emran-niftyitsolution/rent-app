      ...
      <ScrollView className="flex-1">
          ...
          <View className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <View className="mt-6 space-y-4">
              ...
              <View className="flex-row items-center justify-between py-3 border-b border-gray-100">
                ...
                <Text className="text-gray-900 font-semibold text-base">Jan 2024</Text>
              </View>
        ...
        <View className="px-6 mb-6">
          <View className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text className="text-gray-900 font-semibold text-base">Edit Profile</Text>
            </TouchableOpacity>
            <TouchableOpacity
              className="px-6 py-4 border-b border-gray-100"
              activeOpacity={0.7}
            >
              <Text className="text-gray-900 font-semibold text-base">Notifications</Text>
            </TouchableOpacity>
            <TouchableOpacity
              className="px-6 py-4 border-b border-gray-100"
              activeOpacity={0.7}
            >
              <Text className="text-gray-900 font-semibold text-base">Privacy</Text>
            </TouchableOpacity>
            <TouchableOpacity className="px-6 py-4" activeOpacity={0.7}>
              <Text className="text-gray-900 font-semibold text-base">Help & Support</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View className="px-6 mb-8">
          ...
          >
            ...
            >
              <Text className="text-white text-lg font-bold tracking-wide">Logout</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </ScrollView>
